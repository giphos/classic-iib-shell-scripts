...
# Global variables for this script - USE PROPERTY FILE INSTEAD!!! 
...
sh ./create.Active.QueueManager.sh ${_QMGRNAME}

#Create Active Broker
log " "
log "I Creating Active Broker ${_BRKNAME}"
mqsicreatebroker ${_BRKNAME} -q ${_QMGRNAME} -e ${_WMBSHAREDATA}

#start Active Broker
log " "
log "I Starting Active Broker ${_BRKNAME}"
mqsistart ${_BRKNAME}
